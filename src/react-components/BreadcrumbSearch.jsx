...
export default function BreadcrumbSearch() {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    navigate('/patients/search-doctor/search1');
  };
  return (
    <div className="breadcrumb-bar overflow-visible">
      ...
      <div className="breadcrumb-bg">
        <img src="/assets/img/bg/image1.png" alt="img" className="breadcrumb-bg-01" />
        <img src="/assets/img/bg/image2.png" alt="img" className="breadcrumb-bg-02" />
