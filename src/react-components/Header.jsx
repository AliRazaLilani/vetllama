...
export default function Header() {
  ...
  const [selectedCTA, setSelectedCTA] = useState('order');
  ...
  const toggleSubMenu = (i) => setOpenDropdownIndex(openDropdownIndex === i ? null : i);
          ...
          <div className="header-menu">
            <div className="main-menu-wrapper">
              ...
              <ul className="main-nav">
                {/* Header menu items are dynamic in Angular; replicate simple static placeholder if needed */}
