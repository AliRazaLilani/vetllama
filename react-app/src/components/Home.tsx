    ...
    <>
          ...
          <div className="row">
            ...
            <div className="col-xl-6">
              <div className="whychoose-img">
                <img src="/assets/img/about/choose-img-8.webp" alt="choose-img" className="img-fluid img-one" />
                <img src="/assets/img/about/choose-img-9.webp" alt="choose-img" className="img-fluid img-two" />
              </div>
            </div>
          </div>
        </div>
        <img src="/assets/img/about/choose-img-10.png" alt="choose-img" className="img-fluid element-1" />
      </section>
          ...
          <div className="row g-4">
            <div className="col-lg-5">
              <div className="faq-support">
                <img src="/assets/img/icons/support-icon.svg" alt="choose-img" className="img-fluid element-1" />
              ...
              <div className="faq-help">
                <div className="about-popup-item border-0 pb-0 mb-0">
                  <div className="support-item">
                    ...
                    <img src="/assets/img/service/support-img-1.png" alt="support-img-1" className="img-fluid img-1" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="row justify-content-center g-3">
            <div className="col-xl-4 col-md-6">
              <div className="blog-item-six">
                <div className="blog-image">
                  <a href="#"><img className="img-fluid" src="/assets/img/blog/blog-img-1.webp" alt="Post Image" /></a>
                </div>
            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-item-six">
                <div className="blog-image">
                  <a href="#"><img className="img-fluid" src="/assets/img/blog/blog-img-2.webp" alt="Post Image" /></a>
                </div>
                <div className="blog-content">
                  <h3 className="custom-title line-clamp-2">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog-item-six">
                <div className="blog-image">
                  <a href="#"><img className="img-fluid" src="/assets/img/blog/blog-img-3.webp" alt="Post Image" /></a>
                </div>
                <div className="blog-content">
                  <h3 className="custom-title line-clamp-2">
      ...
      <footer className="footer-six footer">
        <div className="footer-top">
              ...
              <div className="col-xl-12 col-lg-12 col-md-12">
                <div className="footer-widget footer-about d-flex justify-content-center align-items-center flex-column">
                  <div className="footer-logo">
                    <img src="/assets/img/logo-33.png" width="200" alt="logo" />
                  </div>
                  <p className="description">
          ...
          <img src="/assets/img/bg/footer-img-1.webp" alt="footer-img-1" className="img-fluid footer-img-1" />
          <img src="/assets/img/icons/banner-icon-6.png" alt="banner-icon" className="img-fluid icon-one" />
          <img src="/assets/img/icons/foot-prints-4.png" alt="banner-icon" className="img-fluid icon-two" />
        </div>
